  ...
  const navGroups: NavGroup[] = [
    {
      ...
      items: [
        ...
        { name: "Registration", href: "/registration", icon: UserPlus, hiddenForRoles: ['principal'] },
        { name: "Schedule Hub", href: "/timetable", icon: CalendarClock },
        { name: "Monthly Overview", href: "/attendance-manager", icon: ClipboardList },
        { name: "Leave Manager", href: "/leaves", icon: PlaneTakeoff },
      ],
    },
    {
      label: "Analytics",
      items: [
        ...
        { name: "Reports", href: "/reports", icon: PieChart, requiredPermission: "canViewReports" },
        { name: "Student Fees", href: "/project-fees", icon: Wallet, requiredPermission: "canViewProjectFees" },
        { name: "Benchmarking", href: "/benchmarking", icon: TrendingUp, requiredPermission: "canViewBenchmarking" },
      ],
    },
    {
      label: "Management",
      items: [
        { name: "Overview", href: "/overview", icon: ScanEye, requiredPermission: "canViewReports" },
        { name: "Faculty Logs", href: "/faculty-logs", icon: Fingerprint, requiredPermission: "canViewReports" },
        { name: "Calendar", href: "/calendar", icon: CalendarHeart, requiredPermission: "canEditCalendar" },
        { name: "Broadcast", href: "/broadcast", icon: Radio, requiredPermission: "canAdminBroadcast" },
      ],
    },
    {
      label: "System",
      items: [
        { name: "Audit Log", href: "/audit-log", icon: ScrollText, requiredPermission: "canViewAuditLog" },
        { name: "Semester Manager", href: "/semester-upgrade", icon: Zap, requiredPermission: "canUpgradeSemester", danger: true },
